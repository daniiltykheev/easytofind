        ...
        <div className="lg:col-span-8 col-span-1">
          <div className="bg-transparent pl-0 pb-8 sm:pb-16">
            ...
            <div className="hidden sm:flex justify-start py-3 border-b border-slate-900 dark:border-slate-200 font-bold text-lg">
              <Link href="/about" class="pr-16 cursor-pointer hover:opacity-50 text-purple-700 dark:text-purple-400">
                What is this?
              </Link>
              {/* <Link href="/hiw" class="cursor-pointer hover:opacity-50">
                How I work
              </Link> */}
              <Link href="/favorites" class="pr-16 cursor-pointer hover:opacity-50">
                Favorites
              </Link>
            ...
            <div className="group sm:hidden relative inline-block border-2 border-zinc-800 dark:border-neutral-200 px-2 py-1 min-w-full">
              <div className="flex justify-between">
                <span className="font-bold text-sm">What is this?</span>
