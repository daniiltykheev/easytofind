...
import { getHIW } from "../services";
import { RichText } from "@graphcms/rich-text-react-renderer";
import { Helmet } from 'react-helmet'
import Link from "next/link";

const HIW = ({ howIWork }) => {
    const content = howIWork.text.json;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-16 gap-12">
        <div className="lg:col-span-8 col-span-1">
          <div className="bg-transparent pl-0 pb-8 sm:pb-16">
            ...
            <div className="hidden sm:flex justify-between pr-24 py-3 border-b border-slate-900 dark:border-neutral-200 font-bold text-lg">
              <Link href="/about" class="cursor-pointer hover:opacity-50">
                What is this?
              </Link>
              <Link href="/hiw" class="cursor-pointer hover:opacity-50 text-purple-700 dark:text-purple-400">
                How I work
              </Link>
            ...
            <div className="group sm:hidden relative inline-block border-2 border-zinc-800 dark:border-neutral-200 px-2 py-1 min-w-full">
              <div className="flex justify-between">
                <span className="font-bold text-sm">How I work</span>
              ...
              <div class="hidden group-hover:block absolute outline outline-2 outline-zinc-800 dark:outline-neutral-200 left-0 bg-neutral-300 dark:bg-zinc-800 w-60 px-2 py-4 mt-1.5 min-w-full">
                ...
                <Link href="/hiw" class="block cursor-pointer hover:opacity-50 text-purple-700 dark:text-purple-400 pb-4 text-sm font-bold">
                  How I work
                </Link>
